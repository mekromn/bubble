...
/** Grey smoked-glass bubble. Shaders live in fixed design coordinates, are allocated once,
...
internal class GlassBubble(context: Context) : View(context) {
    ...
    private val body = LinearGradient(10f,5f,48f,61f,
        intArrayOf(0xd83b3b3b.toInt(),0xe4151515.toInt(),0xf0050505.toInt()),floatArrayOf(0f,.42f,1f),Shader.TileMode.CLAMP)
    private val edge = LinearGradient(9f,5f,54f,61f,
        intArrayOf(0xb0ffffff.toInt(),0x48777777,0x20505050,0x607e7e7e),floatArrayOf(0f,.35f,.72f,1f),Shader.TileMode.CLAMP)
    private val sheen = LinearGradient(17f,8f,30f,33f,0x28ffffff,0x00ffffff,Shader.TileMode.CLAMP)
    private val badge = LinearGradient(45f,4f,57f,24f,0xffe4e4e4.toInt(),0xff999999.toInt(),Shader.TileMode.CLAMP)
    private var label="1"
    ...
    override fun onDraw(canvas: Canvas) {
        ...
        paint.shader=null; paint.style=Paint.Style.STROKE; paint.color=0x80ffffff.toInt(); paint.strokeWidth=.75f
