...
/** Small non-touchable target, detached rather than left transparent over another app. */
internal class DismissTarget(private val context: Context,
    ...
    private class Mark(context: Context) : View(context) {
        ...
        override fun onDraw(c: Canvas) {
            ...
            paint.strokeWidth = 2.5f; paint.color = Ui.TEXT; c.drawLine(46f, 46f, 62f, 62f, paint); c.drawLine(62f, 46f, 46f, 62f, paint)
